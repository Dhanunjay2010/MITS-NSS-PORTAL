  ...
  head: () => ({
    meta: [
      ...
      { title: "MITS NSS Portal — Not Me But You" },
      {
        name: "description",
        content:
          "Official National Service Scheme (NSS) portal of MITS. Explore activities, track attendance, and join community service initiatives.",
      },
      { property: "og:title", content: "MITS NSS Portal — Not Me But You" },
      {
        property: "og:description",
        content:
          "Official NSS portal of MITS. Events, attendance tracking, and volunteer management.",
      },
